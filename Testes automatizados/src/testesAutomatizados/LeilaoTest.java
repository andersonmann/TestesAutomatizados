...
public class LeilaoTest {
	...
	public void deveReceberVariosLances() {
		...
		// leilao.propoe(new Lance(new Usuario("Steve Wozniak"), 5000));
		// leilao.propoe(new Lance(new Usuario("Steve Wozniak"), 63000));
		// leilao.propoe(new Lance(new Usuario("Steve Wozniak"), 35000));
		// leilao.propoe(new Lance(new Usuario("Steve Wozniak"), 35000));
